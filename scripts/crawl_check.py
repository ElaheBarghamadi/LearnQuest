...
ANON_URLS = [
    '/', '/blog/', '/blog/article/1/', '/language/', '/academy/', '/academy/world/4/',
    '/academy/chapter/9/', '/academy/vocabulary/', '/academy/idioms/',
...
AUTH_URLS = [
    ...
    '/academy/dashboard/', '/academy/chapter/9/', '/academy/lesson/29/',
    '/academy/quiz/29/', '/academy/exam/10/', '/academy/writing/',
    ...
    '/academy/certificates/', '/academy/dialogue/26/',
    '/panel/', '/panel/users/', '/panel/users/2/',
    '/academy/manage/', '/academy/manage/worlds/', '/academy/manage/worlds/4/edit/',
...
def main():
    ...
    for u in ['/panel/', '/panel/users/', '/panel/users/1/', '/panel/users/2/',
              '/academy/manage/', '/academy/manage/worlds/', '/academy/manage/worlds/4/edit/',
              '/academy/manage/chapters/9/edit/', '/academy/manage/lessons/29/edit/',
              '/academy/manage/vocabulary/', '/academy/manage/vocabulary/categories/',
              '/academy/manage/quizzes/', '/academy/manage/quizzes/29/questions/',
              '/academy/manage/exams/', '/academy/manage/exams/10/questions/',
