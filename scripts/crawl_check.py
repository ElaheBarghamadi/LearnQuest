...
ANON_URLS = [
    '/', '/blog/', '/blog/article/1/', '/language/', '/academy/', '/academy/world/7/',
    '/academy/chapter/14/', '/academy/vocabulary/', '/academy/idioms/',
...
AUTH_URLS = [
    ...
    '/academy/dashboard/', '/academy/chapter/14/', '/academy/lesson/51/',
    '/academy/quiz/51/', '/academy/exam/17/', '/academy/writing/',
    ...
    '/academy/certificates/', '/academy/dialogue/48/',
    '/panel/', '/panel/users/', '/panel/users/2/',
    '/academy/manage/', '/academy/manage/worlds/', '/academy/manage/worlds/7/edit/',
...
def main():
    ...
    for u in ['/panel/', '/panel/users/', '/panel/users/1/', '/panel/users/2/',
              '/academy/manage/', '/academy/manage/worlds/', '/academy/manage/worlds/7/edit/',
              '/academy/manage/chapters/14/edit/', '/academy/manage/lessons/51/edit/',
              '/academy/manage/vocabulary/', '/academy/manage/vocabulary/categories/',
              '/academy/manage/quizzes/', '/academy/manage/quizzes/51/questions/',
              '/academy/manage/exams/', '/academy/manage/exams/17/questions/',
